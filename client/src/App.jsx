            ...
            racks.map(rack => (
              <div key={rack.id} className="relative">
                ...
                <button
                  ...
                  className="absolute top-3 sm:top-4 right-3 sm:right-4 w-8 h-8 flex items-center justify-center text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-full transition-colors"
                  title="랙 삭제"
                >
